...
contract CharityRegistry {
    ...
    //@audit This function checks if a contract is registered and not verified as it is supposed to do.

    function isVerified(address charity) public view returns (bool) {
        return registeredCharities[charity];
    }
    // @audit This function mis missing the 0 address validation check which could make the owner lose ownership of the contract.
